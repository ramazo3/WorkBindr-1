...
export default function Header({ onOpenAI, onOpenMarketplace, onOpenDeveloper, currentUser }: HeaderProps) {
  return (
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <nav className="hidden md:flex items-center space-x-8">
            ...
            <a href="#governance" className="text-slate-600 hover:text-slate-900">Governance</a>
          </nav>

          <div className="flex items-center space-x-4">
            {/* Wallet Connection Status */}
            <div className="flex items-center space-x-2 px-3 py-2 bg-emerald-100 rounded-lg border border-emerald-200">
